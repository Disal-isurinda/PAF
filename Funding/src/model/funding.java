...
public class funding { // A common method to connect to the DB
...
// execute the statement
	...
	public String readfunding() {
		...
		try {
			...
			output = "<table border='1'><tr><th>Funding ID</th>" + "<th>Research Name</th>" + "<th>Value</th>"
					+ "<th>Research ID</th></tr>";
